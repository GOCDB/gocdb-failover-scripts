...
---------------------------------------------------------------
- Logon as root on goc.dl.ac.uk or gocdb-base.esc.rl.ac.uk and go to the '/root/nsupdate_goc' directory:
...
The DNS servers for the egi.eu zone:
ns.muni.cz
ns2.muni.cz
ext-dns-2.cern.ch (secondary dns server)


Contacts
--------
If any issues, contact: operations@egi.eu, it-support@egi.eu 
Also can directly contact: 
peter.solagna@egi.eu, Martin Kuba <makub@egi.eu>
